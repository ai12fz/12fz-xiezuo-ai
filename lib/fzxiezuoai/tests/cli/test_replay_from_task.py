"""Tests for ``fzxiezuoai replay`` and the trained-agents file plumbing."""
...
from fzxiezuoai_cli import replay_from_task
from fzxiezuoai_cli.cli import replay
...
@mock.patch("fzxiezuoai_cli.cli.replay_task_command")
...
@mock.patch("fzxiezuoai_cli.replay_from_task.subprocess.run")
