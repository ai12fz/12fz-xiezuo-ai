...
from fzxiezuoai.agents.agent_builder.base_agent import BaseAgent, _resolve_agent
from fzxiezuoai.context import reset_current_task_id, set_current_task_id
from fzxiezuoai.core.providers.content_processor import process_content
from fzxiezuoai.events.event_bus import crewai_event_bus
from fzxiezuoai.events.event_context import resume_task_scope
...
from fzxiezuoai.utilities.constants import NOT_SPECIFIED, _NotSpecified
...
try:
    from fzxiezuoai_files import FileInput, FilePath, get_supported_content_types
...
from fzxiezuoai.utilities.guardrail_types import (
    GuardrailCallable,
    GuardrailType,
    GuardrailsType,
)
...
class Task(BaseModel):
    ...
    def handle_max_retries_deprecation(self) -> Self:
        if self.max_retries is not None:
            warnings.warn(
                "The 'max_retries' parameter is deprecated and will be removed in 12FZ协作AI v1.0.0. "
...
- Use ```language for code blocks"""
    ...
    def _save_file(self, result: dict[str, Any] | str | Any) -> None:
        ...
        Note:
            ...
            from the fzxiezuoai_tools package:
                pip install 'fzxiezuoai[tools]'
                from fzxiezuoai_tools import FileWriterTool
        ...
        Raises:
            ...
            RuntimeError: If there is an error writing to the file. For cross-platform
                compatibility, especially on Windows, use FileWriterTool from fzxiezuoai_tools
                package.
        """
        ...
        filewriter_recommendation = (
            ...
            "use FileWriterTool from fzxiezuoai_tools package."
        )
