...
from fzxiezuoai.a2a.utils.agent_card import _get_server_config
from fzxiezuoai.a2a.utils.content_type import validate_message_parts
...
if TYPE_CHECKING:
    from fzxiezuoai.a2a.extensions.server import ExtensionContext, ServerExtensionRegistry
...
def _convert_a2a_files_to_file_inputs(
    ...
    """Convert a2a file types to fzxiezuoai FileInput dict.
    ...
    """
    try:
        from fzxiezuoai_files import File, FileBytes
    except ImportError:
        logger.debug("fzxiezuoai_files not installed, returning empty file dict")
        return {}
...
async def execute(
    ...
    """Execute an A2A task using a 12FZ协作AI agent.

    Args:
        agent: The 12FZ协作AI agent to execute the task.
