...
from fzxiezuoai.a2a.extensions.base import (
    A2AExtension,
    ConversationState,
    ExtensionRegistry,
)
from fzxiezuoai.a2a.task_helpers import TaskStateResult
from fzxiezuoai.a2a.templates import (
...
from fzxiezuoai.a2a.utils.delegation import (
...
def _handle_task_completion(
    ...
    Args:
        ...
        task: 12FZ协作AI Task object to update with reference IDs.
        ...
        from_task: Optional 12FZ协作AI Task for event metadata.
        from_agent: Optional 12FZ协作AI Agent for event metadata.
...
def _handle_agent_response_and_continue(
    ...
    """Handle A2A result and get 12FZ协作AI agent's response.
