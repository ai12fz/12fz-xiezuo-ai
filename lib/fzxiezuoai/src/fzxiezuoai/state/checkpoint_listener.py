...
from fzxiezuoai.events.event_bus import CrewAIEventsBus, crewai_event_bus, is_replaying
...
from fzxiezuoai.state.runtime import RuntimeState, _prepare_entities
...
def _do_checkpoint(
    ...
    msg: str = (
        f"Checkpoint saved. Resume with: fzxiezuoai checkpoint resume {checkpoint_id}"
    )
    logger.info(msg)
