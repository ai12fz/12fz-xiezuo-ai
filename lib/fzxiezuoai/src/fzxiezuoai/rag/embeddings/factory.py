...
from fzxiezuoai.rag.core.base_embeddings_callable import EmbeddingFunction
from fzxiezuoai.rag.core.base_embeddings_provider import BaseEmbeddingsProvider
from fzxiezuoai.utilities.import_utils import import_and_validate_definition
...
if TYPE_CHECKING:
    ...
    from fzxiezuoai.rag.embeddings.providers.ibm.embedding_callable import (
    ...
    from fzxiezuoai.rag.embeddings.providers.voyageai.embedding_callable import (
...
PROVIDER_PATHS = {
    "azure": "fzxiezuoai.rag.embeddings.providers.microsoft.azure.AzureProvider",
    "amazon-bedrock": "fzxiezuoai.rag.embeddings.providers.aws.bedrock.BedrockProvider",
    "cohere": "fzxiezuoai.rag.embeddings.providers.cohere.cohere_provider.CohereProvider",
    "custom": "fzxiezuoai.rag.embeddings.providers.custom.custom_provider.CustomProvider",
    "google-generativeai": "fzxiezuoai.rag.embeddings.providers.google.generative_ai.GenerativeAiProvider",
    "google": "fzxiezuoai.rag.embeddings.providers.google.generative_ai.GenerativeAiProvider",
    "google-vertex": "fzxiezuoai.rag.embeddings.providers.google.vertex.VertexAIProvider",
    "huggingface": "fzxiezuoai.rag.embeddings.providers.huggingface.huggingface_provider.HuggingFaceProvider",
    "instructor": "fzxiezuoai.rag.embeddings.providers.instructor.instructor_provider.InstructorProvider",
    "jina": "fzxiezuoai.rag.embeddings.providers.jina.jina_provider.JinaProvider",
    "ollama": "fzxiezuoai.rag.embeddings.providers.ollama.ollama_provider.OllamaProvider",
    "onnx": "fzxiezuoai.rag.embeddings.providers.onnx.onnx_provider.ONNXProvider",
    "openai": "fzxiezuoai.rag.embeddings.providers.openai.openai_provider.OpenAIProvider",
    "openclip": "fzxiezuoai.rag.embeddings.providers.openclip.openclip_provider.OpenCLIPProvider",
    "roboflow": "fzxiezuoai.rag.embeddings.providers.roboflow.roboflow_provider.RoboflowProvider",
    "sentence-transformer": "fzxiezuoai.rag.embeddings.providers.sentence_transformer.sentence_transformer_provider.SentenceTransformerProvider",
    "text2vec": "fzxiezuoai.rag.embeddings.providers.text2vec.text2vec_provider.Text2VecProvider",
    "voyageai": "fzxiezuoai.rag.embeddings.providers.voyageai.voyageai_provider.VoyageAIProvider",
    "watsonx": "fzxiezuoai.rag.embeddings.providers.ibm.watsonx.WatsonXProvider",
}
