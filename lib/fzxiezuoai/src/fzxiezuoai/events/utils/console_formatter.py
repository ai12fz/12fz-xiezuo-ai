...
from fzxiezuoai.version import is_current_version_yanked, is_newer_version_available
    ...
    def _show_version_update_message_if_needed(self) -> None:
        ...
        try:
            ...
            if is_newer and latest:
                message = f"""A new version of 12FZ协作AI is available!

Current version: {current}
Latest version:  {latest}

To update, run: uv sync --upgrade-package fzxiezuoai"""
