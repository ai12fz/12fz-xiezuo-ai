"""Base LLM abstract class for 12FZ协作AI.

This module provides the abstract base class for all LLM implementations
in 12FZ协作AI, including common functionality for native SDK implementations.
"""
...
try:
    from fzxiezuoai_files import format_multimodal_content
...
class BaseLLM(BaseModel, ABC):
    ...
    def _emit_call_started_event(
        ...
        from fzxiezuoai.utilities.serialization import to_serializable
    ...
    def _format_messages(self, messages: str | list[LLMMessage]) -> list[LLMMessage]:
        ...
        from fzxiezuoai.utilities.types import LLMMessage as _LLMMessage
