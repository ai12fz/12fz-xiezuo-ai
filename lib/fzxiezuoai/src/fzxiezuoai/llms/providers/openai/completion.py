...
class OpenAICompletion(BaseLLM):
    ...
    def _convert_tools_for_responses(
        ...
        """Convert 12FZ协作AI tools to Responses API format.
    ...
    def _convert_tools_for_interference(
        ...
        """Convert 12FZ协作AI tool format to OpenAI function calling format."""
        openai_tools = []
    ...
    def get_file_uploader(self) -> Any:
        ...
        """
        try:
            from fzxiezuoai_files.uploaders.openai import OpenAIFileUploader
