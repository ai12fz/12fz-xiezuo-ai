"""OpenAI agent tool adapter for 12FZ协作AI tool integration.

This module contains the OpenAIAgentToolAdapter class that converts 12FZ协作AI tools
...
from fzxiezuoai.utilities.pydantic_schema_utils import force_additional_properties_false
...
class OpenAIAgentToolAdapter(BaseToolAdapter):
    ...
    Converts 12FZ协作AI BaseTool instances to OpenAI Assistant FunctionTool format
    ...
    def configure_tools(self, tools: list[BaseTool]) -> None:
        ...
        Args:
            tools: List of 12FZ协作AI tools to configure.
        """
    ...
    def _convert_tools_to_openai_format(
        ...
        """Convert 12FZ协作AI tools to OpenAI Assistant tool format.
        ...
        def create_tool_wrapper(tool: BaseTool) -> Any:
            ...
            async def wrapper(context_wrapper: Any, arguments: Any) -> Any:
                """Wrapper function to adapt 12FZ协作AI tool calls to OpenAI format.
