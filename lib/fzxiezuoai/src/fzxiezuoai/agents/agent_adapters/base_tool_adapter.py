...
from fzxiezuoai.utilities.string_utils import sanitize_tool_name as _sanitize_tool_name
...
class BaseToolAdapter(ABC):
    """Base class for all tool adapters in 12FZ协作AI.

    This abstract class defines the common interface that all tool adapters
    must implement. It provides the structure for adapting 12FZ协作AI tools to
