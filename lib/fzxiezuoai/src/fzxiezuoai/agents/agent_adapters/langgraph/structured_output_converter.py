"""LangGraph structured output converter for 12FZ协作AI task integration.
...
from fzxiezuoai.agents.agent_adapters.base_converter_adapter import BaseConverterAdapter
