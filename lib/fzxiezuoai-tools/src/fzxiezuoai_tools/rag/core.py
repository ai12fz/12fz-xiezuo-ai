...
import chromadb
from fzxiezuoai.utilities.lock_store import lock as store_lock
from pydantic import BaseModel, Field, PrivateAttr

from fzxiezuoai_tools.rag.base_loader import BaseLoader
from fzxiezuoai_tools.rag.chunkers.base_chunker import BaseChunker
from fzxiezuoai_tools.rag.data_types import DataType
from fzxiezuoai_tools.rag.embedding_service import EmbeddingService
from fzxiezuoai_tools.rag.misc import compute_sha256
        ...
        try:
            ...
            with store_lock(self._lock_name):
                ...
                self._collection = self._client.get_or_create_collection(
                    ...
                    metadata={
                        "hnsw:space": "cosine",
                        "description": "12FZ协作AI Knowledge Base",
                    },
                )
