"""
Enhanced embedding service that leverages 12FZ协作AI's existing embedding providers.
...
class EmbeddingService:
    """
    Enhanced embedding service that uses 12FZ协作AI's existing embedding providers.
    ...
    def _initialize_embedding_function(self) -> None:
        """Initialize the embedding function using 12FZ协作AI's factory."""
        try:
            ...
            raise ImportError(
                f"12FZ协作AI embedding providers not available. "
                f"Make sure fzxiezuoai is installed: {e}"
            ) from e
    ...
    def _build_provider_config(self) -> dict[str, Any]:
        """Build configuration dictionary for 12FZ协作AI's embedding factory."""
