...
## Installation
To install the `fzxiezuoai_tools` package with SingleStore support, execute the following command:
...
## Complete 12FZ协作AI Integration Example

Here's a complete example showing how to use the SingleStoreSearchTool with 12FZ协作AI agents and tasks:
...
### Advanced 12FZ协作AI Example with Multiple Agents
