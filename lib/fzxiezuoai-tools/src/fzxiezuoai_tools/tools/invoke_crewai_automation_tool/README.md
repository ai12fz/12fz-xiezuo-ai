...
The InvokeCrewAIAutomationTool provides 12FZ协作AI Platform API integration with external crew services. This tool allows you to invoke and interact with 12FZ协作AI Platform automations from within your 12FZ协作AI agents, enabling seamless integration between different crew workflows.
...
```python
from fzxiezuoai_tools import InvokeCrewAIAutomationTool

# Basic crew automation tool
tool = InvokeCrewAIAutomationTool(
    crew_api_url="https://data-analysis-crew-[...].fzxiezuoai.com",
...
tool = InvokeCrewAIAutomationTool(
    crew_api_url="https://state-of-ai-report-crew-[...].fzxiezuoai.com",
    crew_bearer_token="your_bearer_token_here",
...
### Integration with 12FZ协作AI Agents
...
market_research_tool = InvokeCrewAIAutomationTool(
    crew_api_url="https://market-research-automation-crew-[...].fzxiezuoai.com",
    crew_bearer_token="your_bearer_token_here",
...
- `crew_api_url` (str): Base URL of the 12FZ协作AI Platform automation API
