...
## Installation
To start using the XMLSearchTool, you must first install the fzxiezuoai_tools package. This can be easily done with the following command:
...
```python
from fzxiezuoai_tools.tools.xml_search_tool import XMLSearchTool
