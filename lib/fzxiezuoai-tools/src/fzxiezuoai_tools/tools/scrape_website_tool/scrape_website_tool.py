...
from fzxiezuoai_tools.security.safe_path import validate_url
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if not BEAUTIFULSOUP_AVAILABLE:
            raise ImportError(
                "beautifulsoup4 is not installed. Please install it with `pip install fzxiezuoai-tools[beautifulsoup4]`"
            )
