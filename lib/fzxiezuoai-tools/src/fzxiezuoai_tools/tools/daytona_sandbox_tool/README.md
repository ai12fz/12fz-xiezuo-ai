...
```shell
uv add "fzxiezuoai-tools[daytona]"
# or
pip install "fzxiezuoai-tools[daytona]"
```
...
```python
from fzxiezuoai_tools import DaytonaPythonTool
...
```python
from fzxiezuoai_tools import DaytonaExecTool, DaytonaFileTool
...
```python
from fzxiezuoai_tools import DaytonaExecTool
