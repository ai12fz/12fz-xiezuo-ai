...
### Step 2: Install 12FZ协作AI Tools

To incorporate this tool into your project, install 12FZ协作AI with tools support:
...
The following example demonstrates how to initialize a specific tool and use it with a 12FZ协作AI agent:
