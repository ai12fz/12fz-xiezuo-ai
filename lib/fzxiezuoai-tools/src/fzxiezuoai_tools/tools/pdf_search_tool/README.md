...
## Installation
To get started with the PDFSearchTool, first, ensure the fzxiezuoai_tools package is installed with the following command:
...
```python
from fzxiezuoai_tools import PDFSearchTool
