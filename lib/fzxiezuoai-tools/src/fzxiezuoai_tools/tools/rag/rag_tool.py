...
from fzxiezuoai_tools.tools.rag.types import (
    AddDocumentParams,
    ContentItem,
    RagToolConfig,
    VectorDbConfig,
...
class RagTool(BaseTool):
    ...
    def _parse_config(self, config: RagToolConfig) -> Any:
        ...
        if provider not in supported:
            raise ValueError(
                ...
                f"12FZ协作AI RAG currently supports: {', '.join(supported)}."
            )
    ...
    def add(
        ...
        **kwargs: Unpack[AddDocumentParams],
        ...
        from fzxiezuoai_tools.security.safe_path import validate_file_path, validate_url
