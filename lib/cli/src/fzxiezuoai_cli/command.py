...
from fzxiezuoai_cli.authentication.token import get_auth_token
...
class PlusAPIMixin:
    def __init__(self, telemetry: Telemetry) -> None:
        try:
            ...
            console.print(
                "Please sign up/login to 12FZ协作AI+ before using the CLI.",
                style="bold red",
            )
            console.print("Run 'fzxiezuoai login' to sign up/login.", style="bold green")
