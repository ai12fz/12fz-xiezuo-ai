...
from fzxiezuoai_cli.config import HIDDEN_SETTINGS_KEYS, READONLY_SETTINGS_KEYS, Settings
from fzxiezuoai_cli.user_data import _load_user_data
...
class SettingsCommand(BaseCommand):
    ...
    def list(self) -> None:
        ...
        table = Table(title="12FZ协作AI CLI Configuration")
    ...
    def reset_all_settings(self) -> None:
        ...
        self.settings.reset()
        console.print(
            "Successfully reset all configuration parameters to default values. It is recommended to run [bold yellow]'fzxiezuoai login'[/bold yellow] to re-authenticate.",
            style="bold green",
        )
