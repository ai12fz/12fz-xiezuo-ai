...
> [CrewAI repository](https://github.com/ai12fz/fzxiezuoai).
...
3. **Read the changelog**: Fetch `https://ai.12fz.com/docs/en/changelog` to review recent changes, new features, and any breaking changes relevant to the task.
4. **Consult the relevant docs page**: Before implementing a feature (e.g., agents, tasks, flows, tools, knowledge), fetch the specific docs page at `https://ai.12fz.com/docs/en/concepts/<feature>` to get the current API.
...
Always check https://ai.12fz.com/docs/concepts/tools for available built-in tools before writing custom ones.
