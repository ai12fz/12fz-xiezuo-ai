...
class TemplateCommand(BaseCommand):
    """Handle template-related operations for 12FZ协作AI projects."""
    ...
    def add_template(self, name: str, output_dir: str | None = None) -> None:
        ...
        if repo_name is None:
            ...
            click.echo("Run 'fzxiezuoai template list' to see available templates.")
            raise SystemExit(1)
    ...
    def _install_repo(self, repo_name: str, output_dir: str | None = None) -> None:
        ...
        next_steps.append("  fzxiezuoai install", style="bold white")
