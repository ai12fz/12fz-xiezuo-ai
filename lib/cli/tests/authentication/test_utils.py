...
from fzxiezuoai_cli.authentication.utils import validate_jwt_token


@patch("fzxiezuoai_core.auth.utils.PyJWKClient", return_value=MagicMock())
@patch("fzxiezuoai_core.auth.utils.jwt")
