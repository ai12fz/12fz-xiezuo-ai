...
from fzxiezuoai_cli.plus_api import PlusAPI
...
class TestPlusAPI(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertIn("12FZ协作AI-CLI/", self.api.headers["User-Agent"])
        self.assertTrue(self.api.headers["X-Crewai-Version"])

    @patch("fzxiezuoai_core.plus_api.PlusAPI._make_request")
    ...
    @patch("fzxiezuoai_core.plus_api.Settings")
    @patch("fzxiezuoai_core.plus_api.httpx.Client")
