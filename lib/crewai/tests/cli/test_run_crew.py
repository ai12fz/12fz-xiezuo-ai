"""Tests for the ``fzxiezuoai run`` command and its subprocess plumbing."""
...
from fzxiezuoai_cli.cli import run
from fzxiezuoai_cli.run_crew import CrewType, execute_command
...
@mock.patch("fzxiezuoai_cli.cli.run_crew")
...
@mock.patch("fzxiezuoai_cli.run_crew.subprocess.run")
@mock.patch(
    "fzxiezuoai_cli.run_crew.build_env_with_all_tool_credentials",
