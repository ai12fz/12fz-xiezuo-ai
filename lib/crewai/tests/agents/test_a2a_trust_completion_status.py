...
def test_trust_remote_completion_status_true_returns_directly():
    ...
    from fzxiezuoai.a2a.wrapper import _delegate_to_a2a
    ...
    with (
        patch("fzxiezuoai.a2a.wrapper.execute_a2a_delegation") as mock_execute,
        patch("fzxiezuoai.a2a.wrapper._fetch_agent_cards_concurrently") as mock_fetch,
    ):
