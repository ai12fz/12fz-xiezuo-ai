...
from fzxiezuoai.llms.base_llm import BaseLLM, JsonResponseFormat, llm_call_context
...
try:
    ...
    raise ImportError(
        'Anthropic native provider not available, to install: uv add "fzxiezuoai[anthropic]"'
    ) from None
...
class AnthropicCompletion(BaseLLM):
    ...
    def _convert_tools_for_interference(
        ...
        """Convert 12FZ协作AI tool format to Anthropic tool use format."""
        anthropic_tools = []
    ...
    def _format_messages_for_anthropic(
        ...
        """
        from fzxiezuoai.llms.cache import CACHE_BREAKPOINT_KEY
    ...
    def get_file_uploader(self) -> Any:
        ...
        """
        try:
            from fzxiezuoai_files.uploaders.anthropic import AnthropicFileUploader
