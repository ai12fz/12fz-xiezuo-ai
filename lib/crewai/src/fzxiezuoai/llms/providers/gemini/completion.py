...
try:
    ...
    raise ImportError(
        'Google Gen AI native provider not available, to install: uv add "fzxiezuoai[google-genai]"'
    ) from None
...
class GeminiCompletion(BaseLLM):
    ...
    def _convert_tools_for_interference(  # type: ignore[override]
        ...
        """Convert 12FZ协作AI tool format to Gemini function declaration format."""
        gemini_tools = []
    ...
    def get_context_window_size(self) -> int:
        ...
        from fzxiezuoai.llm import CONTEXT_WINDOW_USAGE_RATIO, LLM_CONTEXT_WINDOW_SIZES
    ...
    def get_file_uploader(self) -> Any:
        ...
        """
        try:
            from fzxiezuoai_files.uploaders.gemini import GeminiFileUploader
