...
class AzureCompletion(BaseLLM):
    ...
    def _resolve_credential(self) -> Any:
        ...
        try:
            ...
            raise ValueError(
                ...
                'for keyless auth: uv add "fzxiezuoai[azure-ai-inference]"'
            ) from None
    ...
    def _convert_tools_for_interference(  # type: ignore[override]
        ...
        """Convert 12FZ协作AI tool format to Azure OpenAI function calling format.

        Args:
            tools: List of 12FZ协作AI tool definitions
