...
from fzxiezuoai.events.types.llm_events import LLMCallType
from fzxiezuoai.llms.base_llm import BaseLLM, llm_call_context
from fzxiezuoai.llms.providers.utils.common import safe_tool_conversion
from fzxiezuoai.utilities.agent_utils import is_context_length_exceeded
...
try:
    ...
    raise ImportError(
        'AWS Bedrock native provider not available, to install: uv add "fzxiezuoai[bedrock]"'
    ) from None
...
class BedrockCompletion(BaseLLM):
    ...
    async def acall(
        ...
        if not AIOBOTOCORE_AVAILABLE:
            raise NotImplementedError(
                ...
                'Install with: uv add "fzxiezuoai[bedrock-async]"'
            )
    ...
    def _format_tools_for_converse(
        ...
        """Convert 12FZ协作AI tools to Converse API format following AWS specification."""
    ...
    def get_context_window_size(self) -> int:
        ...
        from fzxiezuoai.llm import CONTEXT_WINDOW_USAGE_RATIO
    ...
    def get_file_uploader(self) -> Any:
        ...
        Returns:
            ...
            or None if fzxiezuoai_files is not installed.
        """
        try:
            import boto3
            from fzxiezuoai_files.uploaders.bedrock import BedrockFileUploader
