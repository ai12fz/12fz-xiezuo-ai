...
from fzxiezuoai.rag.chromadb.types import ChromaEmbeddingFunctionWrapper
...
from fzxiezuoai.rag.embeddings.types import ProviderSpec
        ...
        try:
            ...
            if "dimension mismatch" in str(e).lower():
                Logger(verbose=True).log(
                    "error",
                    "Embedding dimension mismatch. This usually happens when mixing different embedding models. Try resetting the collection using `fzxiezuoai reset-memories -a`",
                    "red",
                )
                raise ValueError(
                    "Embedding dimension mismatch. Make sure you're using the same embedding model "
                    "across all operations with this collection."
                    "Try resetting the collection using `fzxiezuoai reset-memories -a`"
                ) from e
