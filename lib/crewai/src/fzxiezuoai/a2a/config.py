...
from fzxiezuoai.a2a.auth.server_schemes import ServerAuthScheme
from fzxiezuoai.a2a.extensions.base import ValidatedA2AExtension
from fzxiezuoai.a2a.types import ProtocolVersion, TransportType, Url
from fzxiezuoai.utilities.pydantic_schema_utils import serialize_model_class
...
try:
    ...
    from fzxiezuoai.a2a.extensions.server import ServerExtension
    from fzxiezuoai.a2a.updates import UpdateConfig
except ImportError:
...
def _get_default_update_config() -> UpdateConfig:
    from fzxiezuoai.a2a.updates import StreamingConfig
...
@deprecated(
    """
    `fzxiezuoai.a2a.config.A2AConfig` is deprecated and will be removed in v2.0.0,
    use `fzxiezuoai.a2a.config.A2AClientConfig` or `fzxiezuoai.a2a.config.A2AServerConfig` instead.
    """,
