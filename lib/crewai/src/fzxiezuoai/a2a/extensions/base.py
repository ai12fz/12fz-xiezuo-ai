"""Base extension interface for 12FZ协作AI A2A wrapper processing hooks.

This module defines the protocol for extending 12FZ协作AI's A2A wrapper functionality
with custom logic for tool injection, prompt augmentation, and response processing.

Note: These are 12FZ协作AI-specific processing hooks, NOT A2A protocol extensions.
