"""Re-exports of shared settings from ``fzxiezuoai_core.settings``.

Existing imports from ``fzxiezuoai.settings`` continue to work; new code should
import from ``fzxiezuoai_core.settings`` directly.
"""

from __future__ import annotations

from fzxiezuoai_core.settings import (
