"""OpenAI agents adapter for 12FZ协作AI integration.

This module contains the OpenAIAgentAdapter class that integrates OpenAI Assistants
with 12FZ协作AI's agent system, providing tool integration and structured output support.
"""
...
from fzxiezuoai.agents.agent_adapters.openai_agents.openai_agent_tool_adapter import (
    OpenAIAgentToolAdapter,
)
from fzxiezuoai.agents.agent_adapters.openai_agents.protocols import (
    AgentKwargs,
    OpenAIAgent as OpenAIAgentProtocol,
    OpenAIAgentsModule,
)
from fzxiezuoai.agents.agent_adapters.openai_agents.structured_output_converter import (
...
class OpenAIAgentAdapter(BaseAgentAdapter):
    ...
    Integrates OpenAI Assistants API with 12FZ协作AI's agent system, providing
