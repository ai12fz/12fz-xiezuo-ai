"""LangGraph agent adapter for 12FZ协作AI integration.

This module contains the LangGraphAgentAdapter class that integrates LangGraph ReAct agents
with 12FZ协作AI's agent system. Provides memory persistence, tool integration, and structured
...
from fzxiezuoai.agents.agent_adapters.langgraph.langgraph_tool_adapter import (
    LangGraphToolAdapter,
)
from fzxiezuoai.agents.agent_adapters.langgraph.protocols import (
    LangGraphCheckPointMemoryModule,
    LangGraphPrebuiltModule,
)
from fzxiezuoai.agents.agent_adapters.langgraph.structured_output_converter import (
...
from fzxiezuoai.utilities import Logger
...
class LangGraphAgentAdapter(BaseAgentAdapter):
    """Adapter for LangGraph agents to work with 12FZ协作AI.

    This adapter integrates LangGraph's ReAct agents with 12FZ协作AI's agent system,
