...
from fzxiezuoai_core.plus_api import AvailableExport, EnvVarEntry, ToolMetadata
from fzxiezuoai_core.project import (
...
from fzxiezuoai_core.tool_credentials import (
...
from fzxiezuoai.flow import Flow
...
def is_valid_tool(obj: Any) -> bool:
    """Check if an object is a valid 12FZ协作AI tool."""
    from fzxiezuoai.tools.base_tool import Tool
...
def _print_no_tools_warning() -> None:
    ...
    console.print(
        ...
        "[green]from fzxiezuoai.tools import BaseTool, tool\n\n"
        "# Tool class example\n"
