"""Interactive chat interface for 12FZ协作AI crews."""
...
def check_conversational_crews_version(
    ...
    """Check if the installed 12FZ协作AI version supports conversational crews.

    Args:
        crewai_version: The current version of 12FZ协作AI.
