...
Manages ~/.fzxiezuoai/skills/{org}/{name}/ as the global skill cache.
...
_CACHE_ROOT = Path.home() / ".fzxiezuoai" / "skills"
...
class SkillCacheManager:
    """Manages the global skill cache at ~/.fzxiezuoai/skills/."""
