...
via the 12FZ协作AI+ API with a global cache at ~/.fzxiezuoai/skills/.
"""
...
class SkillNotCachedError(Exception):
    ...
    def __init__(self, ref: str) -> None:
        super().__init__(
            ...
            f"Run `fzxiezuoai skill install {ref}` to install it first."
        )
        self.ref = ref
...
def resolve_registry_ref(
    ...
    2. ~/.fzxiezuoai/skills/{org}/{name}/ (global cache)
    ...
    """
    from fzxiezuoai.experimental.skills._flag import require_experimental_skills
    from fzxiezuoai.skills.loader import activate_skill
...
def download_skill(
    ...
    try:
        ...
        from fzxiezuoai.experimental.skills.events import (
    ...
    try:
        from fzxiezuoai_core.plus_api import PlusAPI
