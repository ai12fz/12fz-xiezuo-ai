"""Event bus for managing and dispatching events in 12FZ协作AI.

This module provides a singleton event bus that allows registration and handling
of events throughout the 12FZ协作AI system, supporting both synchronous and asynchronous
...
from fzxiezuoai.events.base_events import BaseEvent, get_next_emission_sequence
...
from fzxiezuoai.events.handler_graph import build_execution_plan
from fzxiezuoai.events.types.event_bus_types import (
    AsyncHandler,
    AsyncHandlerSet,
    ExecutionPlan,
    Handler,
...
from fzxiezuoai.events.types.llm_events import LLMStreamChunkEvent
from fzxiezuoai.events.utils.console_formatter import ConsoleFormatter
from fzxiezuoai.events.utils.handlers import (
    _get_param_count,
    is_async_handler,
    is_call_handler_safe,
)
from fzxiezuoai.utilities.rw_lock import RWLock
...
class CrewAIEventsBus:
    """Singleton event bus for handling events in 12FZ协作AI.
    ...
    def register_entity(self, entity: Any) -> None:
        ...
        with self._instance_lock:
            ...
            if self._runtime_state is None:
                from fzxiezuoai import RuntimeState
    ...
    def scoped_handlers(self) -> Generator[None, Any, None]:
        ...
        Example:
            ...
            >>> from fzxiezuoai.events.event_types import CrewKickoffStartedEvent
