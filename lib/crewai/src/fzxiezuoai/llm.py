...
from fzxiezuoai.llms.base_llm import (
    BaseLLM,
    JsonResponseFormat,
    get_current_call_id,
    llm_call_context,
)
from fzxiezuoai.llms.constants import (
    ANTHROPIC_MODELS,
    AZURE_MODELS,
    BEDROCK_MODELS,
    GEMINI_MODELS,
...
from fzxiezuoai.utilities import InternalInstructor
from fzxiezuoai.utilities.exceptions.context_window_exceeding_exception import (
    LLMContextLengthExceededError,
)
from fzxiezuoai.utilities.logger_utils import suppress_warnings
...
try:
    from fzxiezuoai_files import aformat_multimodal_content, format_multimodal_content
...
class LLM(BaseLLM):
    ...
    def __new__(cls, model: str, is_litellm: bool = False, **kwargs: Any) -> LLM:
        ...
        if not LITELLM_AVAILABLE:
            ...
            error_msg = (
                ...
                f"uv add 'fzxiezuoai[litellm]'\n"
                f"or\n"
                f"pip install litellm\n\n"
                f"For more details, see: "
                f"https://docs.fzxiezuoai.com/en/learn/llm-connections"
            )
    ...
    def _get_native_provider(cls, provider: str) -> type | None:
        ...
        if provider == "snowflake":
            from fzxiezuoai.llms.providers.snowflake.completion import SnowflakeCompletion
