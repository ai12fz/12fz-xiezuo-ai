"""Re-exports of version utilities from ``fzxiezuoai_core.version``.

Kept as a stable import path for the framework; new code should import from
``fzxiezuoai_core.version`` directly.
"""
...
from fzxiezuoai_core.version import (
    ...
    get_fzxiezuoai_version as get_fzxiezuoai_version,
