...
from fzxiezuoai_files.core.constants import (
    MAX_CONCURRENCY,
    MULTIPART_CHUNKSIZE,
    MULTIPART_THRESHOLD,
)
from fzxiezuoai_files.core.sources import FileBytes, FilePath
...
class BedrockFileUploader(FileUploader):
    ...
    def __init__(
        ...
        Args:
            ...
            prefix: S3 key prefix for uploaded files (default: "fzxiezuoai-files").
