...
from fzxiezuoai_files.cache.upload_cache import get_upload_cache
from fzxiezuoai_files.core.types import FileInput
from fzxiezuoai_files.formatting.anthropic import AnthropicFormatter
from fzxiezuoai_files.formatting.bedrock import BedrockFormatter
from fzxiezuoai_files.formatting.gemini import GeminiFormatter
from fzxiezuoai_files.formatting.openai import OpenAIFormatter, OpenAIResponsesFormatter
...
from fzxiezuoai_files.uploaders.factory import ProviderType
...
def format_multimodal_content(
    ...
    Example:
        >>> from fzxiezuoai_files import format_multimodal_content, ImageFile
