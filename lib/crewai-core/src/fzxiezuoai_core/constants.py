"""Constants shared by both fzxiezuoai and fzxiezuoai-cli."""
...
DEFAULT_CREWAI_ENTERPRISE_URL: Final[str] = "https://app.fzxiezuoai.com"
...
CREWAI_ENTERPRISE_DEFAULT_OAUTH2_DOMAIN: Final[str] = "login.fzxiezuoai.com"
