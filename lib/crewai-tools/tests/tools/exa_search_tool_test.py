...
from fzxiezuoai_tools import EXASearchTool, ExaSearchTool
import pytest
...
def test_exa_search_tool_initialization():
    with patch.dict(os.environ, {}, clear=True):
        with patch(
            "fzxiezuoai_tools.tools.exa_tools.exa_search_tool.Exa"
        ) as mock_exa_class:
...
def test_exa_search_tool_initialization_with_env_base_url(
    ...
    with patch("fzxiezuoai_tools.tools.exa_tools.exa_search_tool.Exa") as mock_exa_class:
        ExaSearchTool()
...
def test_exasearchtool_alias_is_deprecated():
    with patch("fzxiezuoai_tools.tools.exa_tools.exa_search_tool.Exa"):
