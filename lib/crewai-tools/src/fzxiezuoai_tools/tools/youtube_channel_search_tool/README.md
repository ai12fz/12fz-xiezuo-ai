...
## Installation
To utilize the YoutubeChannelSearchTool, the `fzxiezuoai_tools` package must be installed. Execute the following command in your shell to install:
...
```python
from fzxiezuoai_tools import YoutubeChannelSearchTool
