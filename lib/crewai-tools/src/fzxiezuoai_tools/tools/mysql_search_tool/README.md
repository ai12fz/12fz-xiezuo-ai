...
## Installation
To install the `fzxiezuoai_tools` package and utilize the MySQLSearchTool, execute the following command in your terminal:
...
```python
from fzxiezuoai_tools import MySQLSearchTool
