...
## Installation
Install the `fzxiezuoai_tools` package to use the DirectoryReadTool in your project. If you haven't added this package to your environment, you can easily install it with pip using the following command:

```shell
pip install 'fzxiezuoai[tools]'
```

This installs the latest version of the `fzxiezuoai_tools` package, allowing access to the DirectoryReadTool and other utilities.
...
```python
from fzxiezuoai_tools import DirectoryReadTool
