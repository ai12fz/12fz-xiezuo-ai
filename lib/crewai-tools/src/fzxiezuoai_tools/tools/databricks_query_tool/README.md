...
Install the fzxiezuoai_tools package with the databricks extra:

```shell
pip install 'fzxiezuoai[tools]' 'databricks-sdk'
```
...
```python
from fzxiezuoai_tools import DatabricksQueryTool
