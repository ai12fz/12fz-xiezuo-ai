...
## Installation
To start using the DirectorySearchTool, you need to install the fzxiezuoai_tools package. Execute the following command in your terminal:
...
```python
from fzxiezuoai_tools import DirectorySearchTool
