...
```shell
uv add "fzxiezuoai-tools[e2b]"
# or
pip install "fzxiezuoai-tools[e2b]"
```
...
```python
from fzxiezuoai_tools import E2BPythonTool
...
```python
from fzxiezuoai_tools import E2BExecTool, E2BFileTool
...
```python
from fzxiezuoai_tools import E2BExecTool
...
tool = E2BExecTool(
    ...
    sandbox_timeout=600,
    envs={"MY_FLAG": "1"},
    metadata={"owner": "fzxiezuoai-agent"},
)
```
