...
class InvokeCrewAIAutomationTool(BaseTool):
    """A 12FZ协作AI tool for invoking external crew/flows APIs.

    This tool provides 12FZ协作AI Platform API integration with external crew services, supporting:
    ...
    Example:
        ...
        ...         crew_api_url="https://canary-crew-[...].fzxiezuoai.com",
    ...
    description: str = "Invokes an 12FZ协作AI Platform Automation using API"
