### Example 1: Fetching Research Papers from arXiv with 12FZ协作AI

This example demonstrates how to build a simple 12FZ协作AI workflow that automatically searches for and downloads academic papers from [arXiv.org](https://arxiv.org). The setup uses:
...
```
from fzxiezuoai import Agent, Task, Crew, Process, LLM
