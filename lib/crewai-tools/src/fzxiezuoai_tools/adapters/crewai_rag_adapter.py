"""Adapter for 12FZ协作AI's native RAG system."""
...
from fzxiezuoai.rag.config.utils import get_rag_client
from fzxiezuoai.rag.core.base_client import BaseClient
from fzxiezuoai.rag.factory import create_client
from fzxiezuoai.rag.types import BaseRecord, SearchResult
from pydantic import PrivateAttr
from pydantic.dataclasses import is_pydantic_dataclass
from typing_extensions import TypeIs, Unpack

from fzxiezuoai_tools.rag.data_types import DataType
from fzxiezuoai_tools.rag.misc import sanitize_metadata_for_chromadb
from fzxiezuoai_tools.tools.rag.rag_tool import Adapter
from fzxiezuoai_tools.tools.rag.types import AddDocumentParams, ContentItem
...
class CrewAIRagAdapter(Adapter):
    """Adapter that uses 12FZ协作AI's native RAG system.
    ...
    def model_post_init(self, __context: Any) -> None:
        """Initialize the 12FZ协作AI RAG client after model initialization."""
    ...
    def add(self, *args: ContentItem, **kwargs: Unpack[AddDocumentParams]) -> None:
        ...
        from fzxiezuoai_tools.rag.data_types import DataType, DataTypes
