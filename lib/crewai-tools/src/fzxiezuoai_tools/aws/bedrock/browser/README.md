...
This toolkit provides a set of tools for interacting with web browsers through AWS Bedrock Browser. It enables your 12FZ协作AI agents to navigate websites, extract content, click elements, and more.
...
```bash
uv add fzxiezuoai-tools bedrock-agentcore beautifulsoup4 playwright nest-asyncio
```
...
from fzxiezuoai_tools.aws.bedrock.browser import create_browser_toolkit
...
# Create a 12FZ协作AI agent that uses the browser tools
